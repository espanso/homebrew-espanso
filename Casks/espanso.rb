cask "espanso" do
  ...
  if Hardware::CPU.intel?
    url "https://github.com/federico-terzi/espanso/releases/download/#{version}/Espanso-Mac-Intel.zip"
    sha256 "6e4db4dfd40405411260feeac5006dc1814de98653c2e52d952d1b56e08f6400"
  else
    url "https://github.com/federico-terzi/espanso/releases/download/#{version}/Espanso-Mac-M1.zip"
